...
public class easyleveltitlepage implements ActionListener{
    JFrame frame;
    ...
    public easyleveltitlepage(){
        soundMode=0;
        click=new PlaySound();
        newgameBG=new PlaySound();
        
        
        loadingBGIcon=new ImageIcon("Images/easyleveltitlepage.png");
    ...
    public static void main(String[] args){
        easyleveltitlepage bg = new easyleveltitlepage();
        bg.setFrame();
    }
